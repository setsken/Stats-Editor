...
const DATABASE_URL = process.env.FARMED_DATABASE_URL || process.env.DATABASE_URL;
const BATCH_SIZE = 500;

if (!DATABASE_URL) {
  console.error('ERROR: Set FARMED_DATABASE_URL environment variable');
  console.error('Usage: FARMED_DATABASE_URL=postgresql://... node migrate-farmed-models.js [path-to-sqlite]');
  process.exit(1);
}
