...
# Find and replace the UPSERT block with simple SELECT/INSERT/UPDATE logic
old_code = '''      // Use UPSERT to ensure only ONE subscription record per user
...
new_code = '''      // Check if user has existing subscription
